...
namespace CosmeticShop.Data.Concrete.Configs
{
    public class ProductConfig : IEntityTypeConfiguration<Product>
    {
        public void Configure(EntityTypeBuilder<Product> entityTypeBuilder)
        {
            ...
            entityTypeBuilder.Property(p => p.Price).IsRequired().HasColumnType("real"); //Sqlite için
            entityTypeBuilder.Property(p => p.CreatedDate).HasDefaultValueSql("date('now')"); //Sqlite için
            entityTypeBuilder.Property(p => p.ModifiedDate).HasDefaultValueSql("date('now')"); //Sqlite için
