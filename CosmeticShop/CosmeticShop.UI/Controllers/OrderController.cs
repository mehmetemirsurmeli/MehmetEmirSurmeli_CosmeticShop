    ...
    public class OrderController : Controller
    {
        ...
        public async Task<IActionResult> Checkout(OrderViewModel orderViewModel)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                options.ApiKey = "sandbox-CGVpqCNT4YJDqp2Knvt7QxG7mD6uxg3r";
                options.SecretKey = "sandbox-phZzImBkZ5klpS9ewr9vjkmlbO3FGTls";
                options.BaseUrl = "https://sandbox-api.iyzipay.com";

                //Yapılacak ödeme isteği için nesne yaratılıyor
                CreatePaymentRequest request = new CreatePaymentRequest();
                request.Locale = Locale.TR.ToString();
                request.ConversationId = "CosmeticShop";
